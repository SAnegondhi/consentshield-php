...
3. **Java + Go libraries (G-024)** — `com.consentshield:consentshield-client:1.0.0` on Maven Central; `github.com/SAnegondhi/consentshield-go` Go module. API parity. Spring Boot (Java) + net/http (Go) examples.
