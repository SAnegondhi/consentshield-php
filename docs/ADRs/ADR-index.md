...
| ADR-1010 | Cloudflare Worker — scoped-role migration off HS256 JWT (Hyperdrive / direct Postgres; Supabase is rotating legacy HS256 signing secret → SUPABASE_WORKER_KEY is on a kill-timer); Phase 2 Sprint 2.1 engineering done 2026-04-22 (cs_worker role already LOGIN-enabled with correct grant set; skip-on-missing-env test written); operator steps (password rotate + wrangler) pending, Phase 1 Hyperdrive prototype still needed | In Progress | 2026-04-21 | 4 | 6 |
