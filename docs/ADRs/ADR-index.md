...
| ADR-1013 | `cs_orchestrator` direct-Postgres migration (Next.js runtime) — completes ADR-1009 Phase 2 scope for the last scoped role on the customer-app surface. Phase 1 + Sprint 2.1 shipped 2026-04-21 (signup-intake + invitation-dispatch + lookup-invitation + internal/invites migrated, architecture doc + Rule 5 synced). Sprint 2.2 (run-probes) deferred — non-blocking single caller. | In Progress | 2026-04-21 | 2 | 3 |
