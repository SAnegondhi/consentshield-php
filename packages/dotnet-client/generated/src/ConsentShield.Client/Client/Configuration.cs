...
namespace ConsentShield.Client.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.consentshield.in/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.consentshield.in/v1"},
                        {"description", "Production"},
                    }
                },
                {
                    new Dictionary<string, object> {
                        {"url", "https://app.consentshield.in/api/v1"},
                        {"description", "Production (legacy app-host path)"},
                    }
                }
            };
        ...
        public Configuration(
            ...
            string basePath = "https://api.consentshield.in/v1") : this()
        {
        ...
        {
            string report = "C# SDK (ConsentShield.Client) Debug Report:\n";
