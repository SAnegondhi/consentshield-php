...
class VerifyBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['identifiers']) > 10000)) {
            $invalidProperties[] = "invalid value for 'identifiers', number of items must be less than or equal to 10000.";
        }
    ...
    public function setIdentifiers($identifiers)
    {
        ...
        if ((count($identifiers) > 10000)) {
            throw new \InvalidArgumentException('invalid value for $identifiers when calling VerifyBatchRequest., number of items must be less than or equal to 10000.');
        }
        if ((count($identifiers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $identifiers when calling VerifyBatchRequest., number of items must be greater than or equal to 1.');
        }
