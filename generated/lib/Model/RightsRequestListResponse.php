...
/**
 * RightsRequestListResponse Class Doc Comment
 *
 * @category Class
 * @package  ConsentShield\Client
 * @author   OpenAPI Generator team
 ...
 */
class RightsRequestListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RightsRequestListResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\ConsentShield\Client\Model\RightsRequestItem[]',
        'next_cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \ConsentShield\Client\Model\RightsRequestItem[]
     */
     ...
     * Sets items
     *
     * @param \ConsentShield\Client\Model\RightsRequestItem[] $items items
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string $next_cursor Opaque keyset cursor; echo in the next request's `cursor` query param.
     *
     * @return self
     */
